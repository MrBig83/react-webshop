      ...
      >
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item name="_id" label="Id" rules={[{ required: false }]}>
                <Input
                  disabled={true}
                  placeholder="Produkt ID genereras automatiskt"
                />
              </Form.Item>
            </Col>
            <Col span={12}>
            ...
            <Col span={12}>
              ...
              >
                <Input style={{ width: "100%" }} placeholder="Bild url" />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
          ...
          <Col span={24}>
            <Form.Item label="Dold produkt?" name="deleted">
